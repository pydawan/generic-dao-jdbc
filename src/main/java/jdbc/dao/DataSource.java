...
public class DataSource {
	...
	private static void validateParams(String url, String username, String password, String driver)
			throws DAOException {
		String message = null;

		if (url == null || url.isBlank()) {
			message = MESSAGE_URL_NOT_FOUND;
		} else if (username == null || username.isBlank()) {
			message = MESSAGE_USERNAME_NOT_FOUND;
		} else if (password == null || password.isBlank()) {
			message = MESSAGE_PASSWORD_NOT_FOUND;
		} else if (driver == null || driver.isBlank()) {
			message = MESSAGE_DRIVER_NOT_FOUND;
		}
